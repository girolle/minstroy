...
['',
	...
	"В открытом доступе может быть недостоверная и неактуальная информация, в том числе не забывайте про расходы на перевод. Получая информацию напрямую от государственных органов зарубежных стран можно быть уверенным в достоверности и полноте предоставленной информации",
	"Успех реализации проекта во многом зависит от ответственного и профессионального подхода на этапе подготовке. Получая информацию напрямую от государственных органов зарубежных стран можно быть уверенным в достоверности и полноте предоставленной информации"
],
['',
	"Излюбленный многими метод проб и ошибок. Данный этап – самое сложное, запутанное и неподконтрольное исполнителю проекта. Важно понимать все процедуры, знать все инстанции, участвующие в экспертизе и проверке проекта чтобы начать его реализацию в изначально запланированные сроки",
	"Лишние затраты и отсутствие контроля над процессом и результатом. Прохождение данного этапа самое сложное, запутанное и неподконтрольное исполнителю проекта. Важно понимать все процедуры, знать все инстанции, участвующие в экспертизе и проверке проекта чтобы начать его реализацию в изначально запланированные сроки",
	"Прохождение данного этапа самое сложное, запутанное и неподконтрольное исполнителю проекта. Важно понимать все процедуры, знать все инстанции, участвующие в экспертизе и проверке проекта чтобы начать его реализацию в изначально запланированные сроки"
],
['',
	"Ваш бывший подрядчик может не иметь опыта реализации международных проектов, не соответствовать международным требованиям или не устраивать компанию-партнера. Необходимо прийти к взаимоприемлемому выбору, которого возможно достичь путем сотрудничества с зарубежными государственными структурами, которые всегда имеют реестр подрядных организаций, из которого можно подобрать подходящий вариант согласно индивидуальным характеристикам.",
	...
	"Хвалим Вашу инициативность, но наилучший вариант можно найти путем сотрудничества с зарубежными государственными структурами, которые всегда имеют реестр подрядных организаций, из которого можно подобрать подходящий вариант согласно индивидуальным характеристикам."
],
['',
	"Затянуто, непредсказуемо, стихийно. Как уже отмечали ранее, в работе различных совещательных органов при Минстрое России задействованы такие участники как инвестиционные фон и государственные органы. В ходе обсуждения прорабатываются все этапы реализации проекта в том числе возможность включения в государственные и социальные программы. В свою очередь комплексный подход позволяет максимально предрассчитать окупаемость проекта.",
	"Отсутствуют гарантии и контроль. Как уже отмечали ранее, в работе различных совещательных органов при Минстрое России задействованы такие участники как инвестиционные фон и государственные органы. В ходе обсуждения прорабатываются все этапы реализации проекта в том числе возможность включения в государственные и социальные программы. В свою очередь комплексный подход позволяет максимально предрассчитать окупаемость проекта.",
	"Как уже отмечали ранее, в работе различных совещательных органов при Минстрое России задействованы такие участники как инвестиционные фон и государственные органы. В ходе обсуждения прорабатываются все этапы реализации проекта в том числе возможность включения в государственные и социальные программы. В свою очередь комплексный подход позволяет максимально предрассчитать окупаемость проекта."
]
]
